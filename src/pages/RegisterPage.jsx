...
import { Eye, EyeOff, ArrowRight, ArrowLeft, UserPlus, Building2, User, Lock, Globe, Check } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit}>
            {step === 1 && (
              <div className="step-content">
                ...
                <button type="button" onClick={nextStep} className="auth-btn-primary w-full">
            ...
            {step === 2 && (
              <div className="step-content">
                <div className="auth-input-group">
                  <label>Login Email Address <span>*</span></label>
                ...
                <div className="auth-input-group" style={{ marginTop: 24, padding: 16, background: '#f8fafc', borderRadius: 10, border: '1px solid #e2e8f0' }}>
                  <label style={{ display: 'flex', gap: 12, cursor: 'pointer', marginBottom: 0, fontWeight: 500, lineHeight: 1.4 }}>
                    ...
                    <span>I hereby declare that the above information is true and correct to the best of my knowledge and belief. <span>*</span></span>
                  </label>
                </div>
                
                <div style={{ display: 'flex', gap: 12, marginTop: 24 }}>
                  <button type="button" onClick={prevStep} className="auth-btn-outline" style={{ flex: 1 }}>
